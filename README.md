...
To use this program, you will need to install Python 3. It does not matter which version of Python you use as long as it is above 3. Additionally, be sure to install the module "pynput" and "pyautogui" using `pip install pynput` and `pip install pyautogui`.
